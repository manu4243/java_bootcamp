...
public class Survey {
    public static void main(String[] args) {
        ...
        counter++;
        double totalPriceOnCoffee = (coffeePrice * coffeeAmount);
        double totalPriceOnFood = (foodPrice * foodAmount);
        //*********PART B: RESPONDING TO THE USER**********
        System.out.println("Thank you " + name + " for answering all " + counter + " questions");
        System.out.println("Weekly, you spend " + totalPriceOnCoffee + " on coffee");
        System.out.println("Weekly, you spend " + totalPriceOnFood + " on food");
